...
Qp.KE  = 1./(exp(-Ep.T(1,1))*1000/2.2);
Qp.KI  = 1./(exp(-Ep.T(1,2))*1000/5);
Qp.KN  = 1./(exp(-Ep.T(1,3))*1000/100);
Qp.KB  = 1./(exp(-Ep.T(1,4))*1000/300);  
Qp.KM  = 1./(exp(-Ep.T(1,5))*1000/160);  
Qp.KH  = 1./(exp(-Ep.T(1,6))*1000/100);  
